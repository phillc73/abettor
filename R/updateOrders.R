#' Return current orders data \link{https://api.developer.betfair.com/services/webapps/docs/display/1smk3cen4v3lu3yomq5qye0ni/updateOrders}
#'
...
#'
#' @param marketId String. The market ID of the bets to be updated. While many bets can be
...
#' 
#' @param PersistenceType vector (strings). The persistence state of updated bets. PersistanceType
#' can take three values ("LAPSE","PERSIST","MARKET_ON_CLOSE", which correspond to Cancel, Keep and Take SP on the desktop website)
#' 
...
#'   Betfair exchange.}}
#'
#' @section Note on \code{updateOrders}: Unlike some other functions that utilised data
