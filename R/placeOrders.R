...
#'enabled):
#'
#'placeOrders(marketId = "1.124156004", selectionId = "8877720",
#'betType = "LIMIT_ON_CLOSE", betSide="LAY", betSize ="2", reqPrice = "1.1")
#'
...
#'
#'placeOrders(marketId = "1.124156004", selectionId = "8877720",
#'betType = "MARKET_ON_CLOSE", betSide="LAY", betSize ="2")
#'
...
#'
#'placeOrders(marketId = "1.123982139", selectionId = c("58805","68244"),betSide  = "LAY",
#'betSize = c("2","3"), reqPrice = c("1.1","1.2"), persistenceType = c("LAPSE","PERSIST"))
#'
...
#'different sizes and at different prices on different selections on the same market:
#'
#'placeOrders(marketId = "1.123982139", selectionId = c("58805","68244"),betSide  = c("BACK","LAY"),
#'betSize = c("2","3"), reqPrice = c("10","1.2"), persistenceType = c("LAPSE","PERSIST"))
#'
#'}
#'
