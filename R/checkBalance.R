#' Checks account balance on Betfair. See
#' \link{http://learning.betfair.com/en/videos/australian-wallet.html} (video) 
#' or
...
#' your Main wallet or Australian Wallet)
#' 
...
#' account information (balance, exposure, etc).
#' 
#' @seealso 
...
#'   is set to FALSE (as in, main wallet data is returned). Changing this
#'   parameter to FALSE returns Australian account information.
#'   
#'   
