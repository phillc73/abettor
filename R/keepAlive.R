...
#' refreshes the session token, which prevents automatic session expiry and
#' allows the user to continue to make calls to the API. According to the
#' official online documentation, the current session timeout period is four
#' hours (and just 20 mins for the Italian exchange)
#' 
#' See
...
#' 
#' 
#' \code{keepAlive} refreshes your session token.Unlike other Betfair API
#' calls, there are no dangers associated with this function- it simply resets
